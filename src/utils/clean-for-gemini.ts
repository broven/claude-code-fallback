...
export function cleanToolSchemasForGeminiRequest(requestBody: any): any {
  ...
  cleaned.tools = cleaned.tools.map((tool: any) => {
    ...
    if (nextTool.input_schema && typeof nextTool.input_schema === "object") {
      nextTool.input_schema = cleanSchemaForGemini(nextTool.input_schema);
    }
    ...
    if (
      ...
      typeof nextTool.function.parameters === "object"
    ) {
      nextTool.function = {
        ...nextTool.function,
        parameters: cleanSchemaForGemini(nextTool.function.parameters),
      };
    }
